// globals!
// UPDATE LINES 3, 4, 6, 7, & 8 FOR YOUR CANDIDATE:
var candidateFirstName = "Ike";
var candidateLastName = "McCorkle";
var candidateFullName = candidateFirstName + " " + candidateLastName;
var myURL = "ike4co.com";
var candidateOffice = "Congress (CO 4th District)";
var candidateState = "Colorado";

var endorseeInfo = {
	name: candidateFullName,
	officeText: candidateOffice,
...
function imagesAreNowLoaded(){
	...
	var textWidth = ctx.measureText(job + ", " + city + " ").width;
	var textX = w*0.051
	...
	ctx.fillText(job + ", " + city, textX, h*0.415, w*0.9);
	...
	var GENERATED_TEXT = "Generated at " + myURL;
	var GENERATED_HASHTAG = " #IEndorse" + candidateFirstName
